...
func (mr *MockOrderQueueRepositoryMockRecorder) SendOrderToProductionQueue(ctx, order any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOrderQueueRepositoryMockRecorder) SendPendingPaymentOrderMessageToQueue(ctx, order any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
